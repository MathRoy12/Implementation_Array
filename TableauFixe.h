...
public:
    ...
    TableauFixe &operator=(TableauFixe &&pTableauAMouvoir);
    ...
    TableauFixe<T, NewSize> sousEnsemble(int pIndex);
...
template<typename T, size_t S>
template<size_t NewSize>
TableauFixe<T, NewSize> TableauFixe<T, S>::sousEnsemble(int pIndex) {
    TableauFixe<T, NewSize> arr;
